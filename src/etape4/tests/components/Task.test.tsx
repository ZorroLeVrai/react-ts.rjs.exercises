...
describe(Task, () => {
  const taskData = { id: 1, totalTime: "1d", timeToComplete: "1d", taskStatus: TaskStatus.IN_PROGRESS, taskName: "My Task"};
    ...
    ["2h", "3600s", 50]
      ...
      render(
        <Provider store={store}>
          <Task taskData={{...taskData, totalTime, timeToComplete}} isFirst={false} isLast={false} tasksDispatcher={tasksDispatcher}/>
        </Provider>
      );
  ...
  it("should not display the move to top icon", () => {
    render(
      <Provider store={store}>
        <Task taskData={{...taskData, totalTime: "2d", timeToComplete: "1d"}} isFirst={true} isLast={false} tasksDispatcher={tasksDispatcher} />
      </Provider>
    );
  ...
  it("should not display the move to bottom icon", () => {
    render(
      <Provider store={store}>
        <Task taskData={{...taskData, totalTime: "2d", timeToComplete: "1d"}} isFirst={false} isLast={true} tasksDispatcher={tasksDispatcher} />
      </Provider>
    );
  ...
  it("should display the move to bottom and the move to top icons", () => {
    render(
      <Provider store={store}>
        <Task taskData={{...taskData, totalTime: "2d", timeToComplete: "1d"}} isFirst={false} isLast={false} tasksDispatcher={tasksDispatcher}/>
      </Provider>
    );
