...
export type TaskGroupActionType = typeof TaskGroupAction[keyof typeof TaskGroupAction];
 ...
 */
export function tasksReducer(tasks: TaskType[], action: { type: string, payload: TaskType }): TaskType[] {
  ...
  function handleSwapTasks(tasks: TaskType[], firstId: number, secondId: number): TaskType[] {
